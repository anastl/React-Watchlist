...
export default function DetailedMedia( props ) {
    ...
    const addMediaBtn = <button className="details_button" onClick={ () => addElement( obj ) } >Add to watchlist</button>
    const deleteMediaBtn = <button className="details_button" onClick={ () => deleteElement( parseInt( mediaId ) ) } >Delete from watchlist</button>
    ...
    async function getDetails() {
        try {           
            ...
            if ( mediaType === 'movie' ){
                ...
                const movieDets = (
                    <>
                        <img alt="" src={imgSrc} className="media--poster"/>
                        <h3 className="media--title">{ title }</h3>
                        {tagline && <p className="media--tagline">{ tagline }</p>}
                        <div className="media--website--container website-container">
                            <a href={ homepage }>
                                <span>Website</span>
                        ...
                        <p className="p media--details">{ overview }</p>
                        <div className="media--recommendations"></div>
                    </>
                )
                ...
                const lastEpisodeToAir = (
                    <div className="tv--last-episode-container">
                        <span className="last-episode-banner">Last episode aired</span>
                        ...
                        <span className="last-episode-episode-number">Number: {last_episode_to_air.episode_number}</span>
                ...
                const nextEpisodeToAir = (
                    <div className="tv--next-episode-container">
                        ...
                        <span className="next-episode-episode-number">Number: {next_episode_to_air.episode_number}</span>
                ...
                const tvDets = (
                    <>
                        ...
                        <h6 className="tv--title--original">Original name: details { original_name }</h6>
                        ...
                        <p className="details runtime">Runtime: { episode_run_time } minutes</p>
